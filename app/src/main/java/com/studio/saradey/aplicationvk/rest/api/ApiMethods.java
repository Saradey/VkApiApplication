...
public class ApiMethods {
    ...
    public static final String WALL_GET_BY_ID = "wall.getById"; //dля получения стены по id:

    public static final String VIDEO_GET = "video.get";

    public static final String WALL_GET_COMMENTS = "wall.getComments";  //получить комменты
